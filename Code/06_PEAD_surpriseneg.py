...
latex_ready.to_csv("Results/results_MLmodels2_neg.csv")
...
# Save model
dump(best_model, "Models/best_mod_regression_neg.joblib")
...
if hasattr(best_model, 'feature_importances_'):
    ...
    plt.tight_layout()
    plt.savefig("Plots/feature_importance/feature_importance_drift_neg.png", dpi=500)
    plt.show()
else:
...
fig = plt.gcf()
fig.tight_layout()
fig.savefig("Plots/feature_importance/feature_importance_shap_regression_neg.png", dpi=500, bbox_inches="tight")
fig.show()
plt.close(fig)
...
plt.grid(True)
plt.tight_layout()
plt.savefig("Plots/error_analysis/prediction_plot_neg.png")
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("Plots/simulation/sim_returns_drift_neg.png", dpi=500)
plt.show()
